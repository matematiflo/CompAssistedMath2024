...
\begin{frame}[fragile]{Definitions}
    \begin{definition}[Convergence of a sequence]
        A sequence $(a_n)$ converges to $x$ if for every $\epsilon > 0$, there exists an $m \in \mathbb{N}$ such that for all $n \geq m$ we have $|a_m - x| < \epsilon$.
    \end{definition}
...
\begin{frame}[fragile]{Lemmas}
    \begin{lemma}[Sandwich theorem]
        If $(a_n)$, $(b_n)$ and $(c_n)$ are sequences and there exists an $m \in \mathbb{N}$ such that $a_m \leq b_m \leq c_m$ for all $m \geq n$, and both $(a_n)$ and $(c_n)$ converge to $x$, then $(b_n)$ converges to $x$.
    \end{lemma}
...
\begin{frame}{Math Proof}
    \begin{proofs}[Proof continued]
        ...
        \end{align*}
        They fulfill the condition $b_n \leq a_n \leq c_n$ for all $n \geq 2$:
        \begin{align*}
...
\begin{frame}{Math Proof}
    \begin{proof}[Proof continued]
        ...
        \]
        \[
        \lim_{n \to \infty} \left(1 + \sqrt{\frac{2}{n-1}} \right) = 1
        \]\\
